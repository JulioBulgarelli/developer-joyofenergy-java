...
public class PricePlanService {
    ...
    public PricePlanService(List<PricePlan> pricePlans, MeterReadingService meterReadingService) {
        log.info("Instantiating Bean || pricePlans = {} || meterReadingService = {}", pricePlans, meterReadingService);
    ...
    private BigDecimal calculateCost(List<ElectricityReading> electricityReadings, PricePlan pricePlan) {
        ...
        if (electricityReadings.isEmpty()) {
            ...
            return reading.reading().divide(BigDecimal.valueOf(reading.time().getEpochSecond()), RoundingMode.HALF_UP);
        }
